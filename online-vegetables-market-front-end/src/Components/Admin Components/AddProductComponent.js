...
import GrocessoryImg2 from './Images/GrocessoryImg2.jpg'
   ...
   const [img, setImg] = useState('');
    ...
    const saveProduct = (e) => {
        ...
        ProductServices.AddProductByCategory(id, saveProduct).then(res => {
            ...
            res.data.result === null && alert(res.data.message + "🙃");
            props.history.push(`/admin-product-under-category/${id}`)
        });
    }
                ...
                <div className='row'>
                    <div className="col-md-4 mr-n4 ">
                        <div className="card h-100 w-100">
                            <img className='h-100 w-100' src={GrocessoryImg2} alt="Image"></img>
                        </div>
                    </div>
                    <div className="col">
                        <div className='card'>
